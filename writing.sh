...
while [ $counter -le 10 ]
do
	./first_optimization "$N" "$file" "$n_steps" "$delta" "$theta" "$graphics"
	((counter++))
done
printf '\n \n \n'
...
while [ $counter -le 10 ]
do
	./second_optimization  "$N" "$file" "$n_steps" "$delta" "$theta" "$graphics"
	((counter++))
done
printf '\n \n \n'
...
while [ $counter -le 10 ]
do
	./third_optimization  "$N" "$file" "$n_steps" "$delta" "$theta" "$graphics"
	((counter++))
done
printf '\n \n \n'
...
while [ $counter -le 10 ]
do
	./ffast_math "$N" "$file" "$n_steps" "$delta" "$theta" "$graphics"
	((counter++))
done
printf '\n \n \n'
