...
inline void get_acc_on_body(double pos_x, double pos_y, node_t ** node, double theta_max, double G){
  ...
  if((*node)->right_up == NULL){
    ...
    */
    ...
    //calculate force //CHANGE 1: Delete pow, substitute by arithmetic
    double denominator = (sqrtf(x_direction*x_direction +
    y_direction*y_direction)+epsilon_0);
